...
<template>
    <TransitionRoot :show="!isDestroyed" appear>
        ...
        >
            <div
                :class="`bg-gray-200 bg-gradient-to-r shadow-white/50 p-6 rounded-md shadow-lg flex space-x-6 ${selectedStyle} dark:(bg-slate-800 shadow-slate-900/50)`"
            >
                ...
                <div>
                    <button
                        class="text-slate-600 font-bold hover:text-red-500 dark:text-gray-400"
                        @click="close"
                    >
