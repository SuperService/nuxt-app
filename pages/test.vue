            ...
            <PageSection>
                ...
                <div>
                    ...
                    <div
                        ...
                        <Button class="w-full lg: w-auto capitalize" type="secondary" size="sm"
                            :text="$t('pages.test.increment')" @click.prevent="counter.increment" />
                        <Button class="w-full lg:w-auto" type="secondary" size="sm"
                            :text="`${$t('pages.test.increment')} 2x`" @click.prevent="counter.increment2x" />
                        <Button class="w-full lg:w-auto capitalize" type="secondary" size="sm"
                            :text="$t('pages.test.decrement')" @click.prevent="counter.decrement" />
                        <Button class="w-full lg:w-auto capitalize" type="secondary" size="sm"
                            :text="$t('pages.test.reset')" @click.prevent="counter.reset" />
                    </div>
                </div>
            </PageSection>
            <PageSection>
                ...
                <div class="flex flex-col items-center space-y-2 lg:(space-y-0 flex-row space-x-2)">
                    <FormTextInput 
